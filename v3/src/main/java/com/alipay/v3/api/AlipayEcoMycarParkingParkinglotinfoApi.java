...
import com.alipay.v3.model.AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel;
...
public class AlipayEcoMycarParkingParkinglotinfoApi {
     ...
     * @param alipayEcoMycarParkingParkinglotinfoUpdateModel  (optional)
     * @return AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel update(AlipayEcoMycarParkingParkinglotinfoUpdateModel alipayEcoMycarParkingParkinglotinfoUpdateModel) throws ApiException {
        ApiResponse<AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel> localVarResp = updateWithHttpInfo(alipayEcoMycarParkingParkinglotinfoUpdateModel, null);
        return localVarResp.getData();
    }

    public AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel update(AlipayEcoMycarParkingParkinglotinfoUpdateModel alipayEcoMycarParkingParkinglotinfoUpdateModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel> localVarResp = updateWithHttpInfo(alipayEcoMycarParkingParkinglotinfoUpdateModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     * 录入停车场信息，内容信息通过该接口提交到支付宝，支付宝会生成支付宝这边停车场ID反馈给开发者，用于后续更新和上送车辆信息，停车场名称不允许修改。
     * @param alipayEcoMycarParkingParkinglotinfoUpdateModel  (optional)
     * @return ApiResponse&lt;AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel> updateWithHttpInfo(AlipayEcoMycarParkingParkinglotinfoUpdateModel alipayEcoMycarParkingParkinglotinfoUpdateModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = updateValidateBeforeCall(alipayEcoMycarParkingParkinglotinfoUpdateModel, null, customizedParams);
        try {
            Type localVarReturnType = new TypeToken<AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel>(){}.getType();
            return localVarApiClient.execute(localVarCall, localVarReturnType);
        } catch (ApiException e) {
            try {
     ...
     */
    @Deprecated
    public okhttp3.Call updateAsync(AlipayEcoMycarParkingParkinglotinfoUpdateModel alipayEcoMycarParkingParkinglotinfoUpdateModel, final ApiCallback<AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel> _callback) throws ApiException {
    ...
    @Deprecated
    public okhttp3.Call updateAsync(AlipayEcoMycarParkingParkinglotinfoUpdateModel alipayEcoMycarParkingParkinglotinfoUpdateModel, final ApiCallback<AlipayEcoMycarParkingParkinglotinfoUpdateResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {
