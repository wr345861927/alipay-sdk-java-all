...
import com.alipay.v3.model.AlipayOpenMiniBaseinfoModifyResponseModel;
...
public class AlipayOpenMiniBaseinfoApi {
     ...
     * @param appLogo  (optional)
     * @param data  (optional)
     * @return AlipayOpenMiniBaseinfoModifyResponseModel
     ...
     */
    public AlipayOpenMiniBaseinfoModifyResponseModel modify(File appLogo, AlipayOpenMiniBaseinfoModifyModel data) throws ApiException {
        ApiResponse<AlipayOpenMiniBaseinfoModifyResponseModel> localVarResp = modifyWithHttpInfo(appLogo, data, null);
        return localVarResp.getData();
    }

    public AlipayOpenMiniBaseinfoModifyResponseModel modify(File appLogo, AlipayOpenMiniBaseinfoModifyModel data, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayOpenMiniBaseinfoModifyResponseModel> localVarResp = modifyWithHttpInfo(appLogo, data, customizedParams);
        return localVarResp.getData();
    }
     ...
     * @param appLogo  (optional)
     * @param data  (optional)
     * @return ApiResponse&lt;AlipayOpenMiniBaseinfoModifyResponseModel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AlipayOpenMiniBaseinfoModifyResponseModel> modifyWithHttpInfo(File appLogo, AlipayOpenMiniBaseinfoModifyModel data, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = modifyValidateBeforeCall(appLogo, data, null, customizedParams);
        try {
            Type localVarReturnType = new TypeToken<AlipayOpenMiniBaseinfoModifyResponseModel>(){}.getType();
     ...
     */
    @Deprecated
    public okhttp3.Call modifyAsync(File appLogo, AlipayOpenMiniBaseinfoModifyModel data, final ApiCallback<AlipayOpenMiniBaseinfoModifyResponseModel> _callback) throws ApiException {
    ...
    @Deprecated
    public okhttp3.Call modifyAsync(File appLogo, AlipayOpenMiniBaseinfoModifyModel data, final ApiCallback<AlipayOpenMiniBaseinfoModifyResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {
