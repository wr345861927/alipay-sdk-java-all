...
public class AlipayDataBillAccountbookereceiptApi {
     ...
     * @param fileId 根据申请id查询状态。申请接口可以参考alipay.data.bill.ereceiptagent.apply (optional)
     * @param agreementNo 协议号，根据不同业务协议类型，传入对应类型的协议号，用于isv授权检查并获取商户信息。如果业务类型未指定，则使用默认类型对应的协议号。 (optional)
     * @param agreementType 根据不同业务协议类型，传入不同参数。传入协议产品码（personal_product_code，通过协议查询接口、协议签约通知响应参数获取），不填的话默认按照示例值传入 (optional)
     * @param secure true表示使用安全链接，即返回的下载链接为https。 非true值的情况下，统一为false，使用http链接。 (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(String fileId, String agreementNo, String agreementType, String secure, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (secure != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("secure", secure));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String fileId, String agreementNo, String agreementType, String secure, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(fileId, agreementNo, agreementType, secure, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayDataBillAccountbookereceiptQueryResponseModel query(String fileId, String agreementNo, String agreementType, String secure) throws ApiException {
        ApiResponse<AlipayDataBillAccountbookereceiptQueryResponseModel> localVarResp = queryWithHttpInfo(fileId, agreementNo, agreementType, secure, null);
        return localVarResp.getData();
    }

    public AlipayDataBillAccountbookereceiptQueryResponseModel query(String fileId, String agreementNo, String agreementType, String secure, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayDataBillAccountbookereceiptQueryResponseModel> localVarResp = queryWithHttpInfo(fileId, agreementNo, agreementType, secure, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayDataBillAccountbookereceiptQueryResponseModel> queryWithHttpInfo(String fileId, String agreementNo, String agreementType, String secure, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(fileId, agreementNo, agreementType, secure, null, customizedParams);
        try {
     ...
     */
    @Deprecated
    public okhttp3.Call queryAsync(String fileId, String agreementNo, String agreementType, String secure, final ApiCallback<AlipayDataBillAccountbookereceiptQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(fileId, agreementNo, agreementType, secure, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayDataBillAccountbookereceiptQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @Deprecated
    public okhttp3.Call queryAsync(String fileId, String agreementNo, String agreementType, String secure, final ApiCallback<AlipayDataBillAccountbookereceiptQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(fileId, agreementNo, agreementType, secure, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayDataBillAccountbookereceiptQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
