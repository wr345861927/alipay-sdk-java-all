...
public class AlipayCommerceEcEmployeeInfoApi {
     ...
     * @param alipayLogonId 支付宝登录号（手机号或邮箱） (optional)
     * @param employeeCertType 员工证件类型 (optional)
     * @param employeeCertNo 员工证件号码 (optional)
     * @param employeeEmail 员工邮箱 (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(String enterpriseId, String openId, String userId, String employeeId, String mobile, String alipayLogonId, String employeeCertType, String employeeCertNo, String employeeEmail, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (employeeCertType != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("employee_cert_type", employeeCertType));
        }

        if (employeeCertNo != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("employee_cert_no", employeeCertNo));
        }

        if (employeeEmail != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("employee_email", employeeEmail));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String enterpriseId, String openId, String userId, String employeeId, String mobile, String alipayLogonId, String employeeCertType, String employeeCertNo, String employeeEmail, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(enterpriseId, openId, userId, employeeId, mobile, alipayLogonId, employeeCertType, employeeCertNo, employeeEmail, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayCommerceEcEmployeeInfoQueryResponseModel query(String enterpriseId, String openId, String userId, String employeeId, String mobile, String alipayLogonId, String employeeCertType, String employeeCertNo, String employeeEmail) throws ApiException {
        ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> localVarResp = queryWithHttpInfo(enterpriseId, openId, userId, employeeId, mobile, alipayLogonId, employeeCertType, employeeCertNo, employeeEmail, null);
        return localVarResp.getData();
    }

    public AlipayCommerceEcEmployeeInfoQueryResponseModel query(String enterpriseId, String openId, String userId, String employeeId, String mobile, String alipayLogonId, String employeeCertType, String employeeCertNo, String employeeEmail, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> localVarResp = queryWithHttpInfo(enterpriseId, openId, userId, employeeId, mobile, alipayLogonId, employeeCertType, employeeCertNo, employeeEmail, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayCommerceEcEmployeeInfoQueryResponseModel> queryWithHttpInfo(String enterpriseId, String openId, String userId, String employeeId, String mobile, String alipayLogonId, String employeeCertType, String employeeCertNo, String employeeEmail, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(enterpriseId, openId, userId, employeeId, mobile, alipayLogonId, employeeCertType, employeeCertNo, employeeEmail, null, customizedParams);
        try {
     ...
     */
    @Deprecated
    public okhttp3.Call queryAsync(String enterpriseId, String openId, String userId, String employeeId, String mobile, String alipayLogonId, String employeeCertType, String employeeCertNo, String employeeEmail, final ApiCallback<AlipayCommerceEcEmployeeInfoQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(enterpriseId, openId, userId, employeeId, mobile, alipayLogonId, employeeCertType, employeeCertNo, employeeEmail, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayCommerceEcEmployeeInfoQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @Deprecated
    public okhttp3.Call queryAsync(String enterpriseId, String openId, String userId, String employeeId, String mobile, String alipayLogonId, String employeeCertType, String employeeCertNo, String employeeEmail, final ApiCallback<AlipayCommerceEcEmployeeInfoQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(enterpriseId, openId, userId, employeeId, mobile, alipayLogonId, employeeCertType, employeeCertNo, employeeEmail, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayCommerceEcEmployeeInfoQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
