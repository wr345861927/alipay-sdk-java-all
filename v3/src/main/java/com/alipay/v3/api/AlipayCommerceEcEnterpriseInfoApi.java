...
public class AlipayCommerceEcEnterpriseInfoApi {
     ...
     * @param enterpriseId 企业id,从企业注册等接口获取，和out_biz_no参数二选一，都传优先取企业id (optional)
     * @param outBizNo 服务商生成的请求唯一流水号/业务幂等号，和enterprise_id参数二选一，都传优先取企业id (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(String enterpriseId, String outBizNo, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String enterpriseId, String outBizNo, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(enterpriseId, outBizNo, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AlipayCommerceEcEnterpriseInfoQueryResponseModel query(String enterpriseId, String outBizNo) throws ApiException {
        ApiResponse<AlipayCommerceEcEnterpriseInfoQueryResponseModel> localVarResp = queryWithHttpInfo(enterpriseId, outBizNo, null);
        return localVarResp.getData();
    }

    public AlipayCommerceEcEnterpriseInfoQueryResponseModel query(String enterpriseId, String outBizNo, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayCommerceEcEnterpriseInfoQueryResponseModel> localVarResp = queryWithHttpInfo(enterpriseId, outBizNo, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AlipayCommerceEcEnterpriseInfoQueryResponseModel> queryWithHttpInfo(String enterpriseId, String outBizNo, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(enterpriseId, outBizNo, null, customizedParams);
        try {
     ...
     */
    @Deprecated
    public okhttp3.Call queryAsync(String enterpriseId, String outBizNo, final ApiCallback<AlipayCommerceEcEnterpriseInfoQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(enterpriseId, outBizNo, _callback, null);
        Type localVarReturnType = new TypeToken<AlipayCommerceEcEnterpriseInfoQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @Deprecated
    public okhttp3.Call queryAsync(String enterpriseId, String outBizNo, final ApiCallback<AlipayCommerceEcEnterpriseInfoQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(enterpriseId, outBizNo, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AlipayCommerceEcEnterpriseInfoQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
