...
public class AntMerchantExpandShopApi {
     ...
     * @param shopType 门店经营类型，01表示直营，02表示加盟 (optional)
     * @param bizSource 团购门店业务类型来源 (optional)
     * @param _callback Callback for upload/download progress
     * @param customizedParams
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call queryCall(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, String needIndustryInfo, String needIndustryLicense, String shopType, String bizSource, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (shopType != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("shop_type", shopType));
        }

        if (bizSource != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("biz_source", bizSource));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryValidateBeforeCall(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, String needIndustryInfo, String needIndustryLicense, String shopType, String bizSource, final ApiCallback _callback, CustomizedParams customizedParams) throws ApiException {
        

        okhttp3.Call localVarCall = queryCall(shopId, storeId, ipRoleId, addressVersion, needRecommend, needIndustryInfo, needIndustryLicense, shopType, bizSource, _callback, customizedParams);
        return localVarCall;
     ...
     */
    public AntMerchantExpandShopQueryResponseModel query(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, String needIndustryInfo, String needIndustryLicense, String shopType, String bizSource) throws ApiException {
        ApiResponse<AntMerchantExpandShopQueryResponseModel> localVarResp = queryWithHttpInfo(shopId, storeId, ipRoleId, addressVersion, needRecommend, needIndustryInfo, needIndustryLicense, shopType, bizSource, null);
        return localVarResp.getData();
    }

    public AntMerchantExpandShopQueryResponseModel query(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, String needIndustryInfo, String needIndustryLicense, String shopType, String bizSource, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AntMerchantExpandShopQueryResponseModel> localVarResp = queryWithHttpInfo(shopId, storeId, ipRoleId, addressVersion, needRecommend, needIndustryInfo, needIndustryLicense, shopType, bizSource, customizedParams);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<AntMerchantExpandShopQueryResponseModel> queryWithHttpInfo(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, String needIndustryInfo, String needIndustryLicense, String shopType, String bizSource, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = queryValidateBeforeCall(shopId, storeId, ipRoleId, addressVersion, needRecommend, needIndustryInfo, needIndustryLicense, shopType, bizSource, null, customizedParams);
        try {
     ...
     */
    @Deprecated
    public okhttp3.Call queryAsync(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, String needIndustryInfo, String needIndustryLicense, String shopType, String bizSource, final ApiCallback<AntMerchantExpandShopQueryResponseModel> _callback) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(shopId, storeId, ipRoleId, addressVersion, needRecommend, needIndustryInfo, needIndustryLicense, shopType, bizSource, _callback, null);
        Type localVarReturnType = new TypeToken<AntMerchantExpandShopQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @Deprecated
    public okhttp3.Call queryAsync(String shopId, String storeId, String ipRoleId, String addressVersion, String needRecommend, String needIndustryInfo, String needIndustryLicense, String shopType, String bizSource, final ApiCallback<AntMerchantExpandShopQueryResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {

        okhttp3.Call localVarCall = queryValidateBeforeCall(shopId, storeId, ipRoleId, addressVersion, needRecommend, needIndustryInfo, needIndustryLicense, shopType, bizSource, _callback, customizedParams);
        Type localVarReturnType = new TypeToken<AntMerchantExpandShopQueryResponseModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
