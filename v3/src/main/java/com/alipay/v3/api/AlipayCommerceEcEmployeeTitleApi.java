...
import com.alipay.v3.model.AlipayCommerceEcEmployeeTitleCreateResponseModel;
...
import com.alipay.v3.model.AlipayCommerceEcEmployeeTitleDeleteResponseModel;
...
public class AlipayCommerceEcEmployeeTitleApi {
     ...
     * @param alipayCommerceEcEmployeeTitleCreateModel  (optional)
     * @return AlipayCommerceEcEmployeeTitleCreateResponseModel
     ...
     */
    public AlipayCommerceEcEmployeeTitleCreateResponseModel create(AlipayCommerceEcEmployeeTitleCreateModel alipayCommerceEcEmployeeTitleCreateModel) throws ApiException {
        ApiResponse<AlipayCommerceEcEmployeeTitleCreateResponseModel> localVarResp = createWithHttpInfo(alipayCommerceEcEmployeeTitleCreateModel, null);
        return localVarResp.getData();
    }

    public AlipayCommerceEcEmployeeTitleCreateResponseModel create(AlipayCommerceEcEmployeeTitleCreateModel alipayCommerceEcEmployeeTitleCreateModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayCommerceEcEmployeeTitleCreateResponseModel> localVarResp = createWithHttpInfo(alipayCommerceEcEmployeeTitleCreateModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     * 批量新增员工抬头关系，单次新增最大一千条
     * @param alipayCommerceEcEmployeeTitleCreateModel  (optional)
     * @return ApiResponse&lt;AlipayCommerceEcEmployeeTitleCreateResponseModel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AlipayCommerceEcEmployeeTitleCreateResponseModel> createWithHttpInfo(AlipayCommerceEcEmployeeTitleCreateModel alipayCommerceEcEmployeeTitleCreateModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = createValidateBeforeCall(alipayCommerceEcEmployeeTitleCreateModel, null, customizedParams);
        try {
            Type localVarReturnType = new TypeToken<AlipayCommerceEcEmployeeTitleCreateResponseModel>(){}.getType();
     ...
     */
    @Deprecated
    public okhttp3.Call createAsync(AlipayCommerceEcEmployeeTitleCreateModel alipayCommerceEcEmployeeTitleCreateModel, final ApiCallback<AlipayCommerceEcEmployeeTitleCreateResponseModel> _callback) throws ApiException {
    ...
    @Deprecated
    public okhttp3.Call createAsync(AlipayCommerceEcEmployeeTitleCreateModel alipayCommerceEcEmployeeTitleCreateModel, final ApiCallback<AlipayCommerceEcEmployeeTitleCreateResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {
     ...
     * 对员工抬头关系做失效处理。
     * @param alipayCommerceEcEmployeeTitleDeleteModel  (optional)
     * @return AlipayCommerceEcEmployeeTitleDeleteResponseModel
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public AlipayCommerceEcEmployeeTitleDeleteResponseModel delete(AlipayCommerceEcEmployeeTitleDeleteModel alipayCommerceEcEmployeeTitleDeleteModel) throws ApiException {
        ApiResponse<AlipayCommerceEcEmployeeTitleDeleteResponseModel> localVarResp = deleteWithHttpInfo(alipayCommerceEcEmployeeTitleDeleteModel, null);
        return localVarResp.getData();
    }

    public AlipayCommerceEcEmployeeTitleDeleteResponseModel delete(AlipayCommerceEcEmployeeTitleDeleteModel alipayCommerceEcEmployeeTitleDeleteModel, CustomizedParams customizedParams) throws ApiException {
        ApiResponse<AlipayCommerceEcEmployeeTitleDeleteResponseModel> localVarResp = deleteWithHttpInfo(alipayCommerceEcEmployeeTitleDeleteModel, customizedParams);
        return localVarResp.getData();
    }
     ...
     * 对员工抬头关系做失效处理。
     * @param alipayCommerceEcEmployeeTitleDeleteModel  (optional)
     * @return ApiResponse&lt;AlipayCommerceEcEmployeeTitleDeleteResponseModel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AlipayCommerceEcEmployeeTitleDeleteResponseModel> deleteWithHttpInfo(AlipayCommerceEcEmployeeTitleDeleteModel alipayCommerceEcEmployeeTitleDeleteModel, CustomizedParams customizedParams) throws ApiException {
        okhttp3.Call localVarCall = deleteValidateBeforeCall(alipayCommerceEcEmployeeTitleDeleteModel, null, customizedParams);
        try {
            Type localVarReturnType = new TypeToken<AlipayCommerceEcEmployeeTitleDeleteResponseModel>(){}.getType();
            return localVarApiClient.execute(localVarCall, localVarReturnType);
        } catch (ApiException e) {
            try {
     ...
     */
    @Deprecated
    public okhttp3.Call deleteAsync(AlipayCommerceEcEmployeeTitleDeleteModel alipayCommerceEcEmployeeTitleDeleteModel, final ApiCallback<AlipayCommerceEcEmployeeTitleDeleteResponseModel> _callback) throws ApiException {
    ...
    @Deprecated
    public okhttp3.Call deleteAsync(AlipayCommerceEcEmployeeTitleDeleteModel alipayCommerceEcEmployeeTitleDeleteModel, final ApiCallback<AlipayCommerceEcEmployeeTitleDeleteResponseModel> _callback, CustomizedParams customizedParams) throws ApiException {
