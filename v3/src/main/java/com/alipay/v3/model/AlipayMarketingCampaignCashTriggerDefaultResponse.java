...
public class AlipayMarketingCampaignCashTriggerDefaultResponse extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<AlipayMarketingCampaignCashTriggerErrorResponseModel> adapterAlipayMarketingCampaignCashTriggerErrorResponseModel = gson.getDelegateAdapter(this, TypeToken.get(AlipayMarketingCampaignCashTriggerErrorResponseModel.class));
            final TypeAdapter<CommonErrorType> adapterCommonErrorType = gson.getDelegateAdapter(this, TypeToken.get(CommonErrorType.class));

            return (TypeAdapter<T>) new TypeAdapter<AlipayMarketingCampaignCashTriggerDefaultResponse>() {
                @Override
    ...
    static {
        schemas.put("AlipayMarketingCampaignCashTriggerErrorResponseModel", new GenericType<AlipayMarketingCampaignCashTriggerErrorResponseModel>() {
        });
