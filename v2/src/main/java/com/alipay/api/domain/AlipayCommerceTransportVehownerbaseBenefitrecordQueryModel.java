 ...
 *
 * @author auto create
 * @since 1.0, 2024-08-09 16:35:16
 */
public class AlipayCommerceTransportVehownerbaseBenefitrecordQueryModel extends AlipayObject {

	private static final long serialVersionUID = 6578938533392494186L;
	 ...
	 */
	@ApiField("components")
	private BenefitRecordQueryComponents components;
	...
	public BenefitRecordQueryComponents getComponents() {
		return this.components;
	}
	public void setComponents(BenefitRecordQueryComponents components) {
