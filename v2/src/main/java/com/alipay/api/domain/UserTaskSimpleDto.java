 ...
 *
 * @author auto create
 * @since 1.0, 2023-07-11 20:01:36
 */
public class UserTaskSimpleDto extends AlipayObject {

	private static final long serialVersionUID = 8773921883387324822L;
...
RECEIVED：任务权益已领取，STOPED：已终止
	...
	public void setCountingInfo(UserTaskCountingDto countingInfo) {
	...
	public void setNodeTaskList(List<UserNodeTaskSimpleDto> nodeTaskList) {
	...
	public void setRightsRuleList(List<TaskRightsRuleDto> rightsRuleList) {
		this.rightsRuleList = rightsRuleList;
	}
