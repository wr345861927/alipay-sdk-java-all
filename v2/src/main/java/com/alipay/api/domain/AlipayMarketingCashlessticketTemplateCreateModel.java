...
public class AlipayMarketingCashlessticketTemplateCreateModel extends AlipayObject {
	...
	private static final long serialVersionUID = 7547252562941384396L;
	...
	/**
	 * 票类型，取值范围为： 
1. 定额无资金代金票：CASHLESS_FIX_TICKET，在创建时需要传入票面额；
2. 不定额无资金代金票 CASHLESS_RANDOM_TICKET，在票发放时传入票面额；
	 */
