...
public class AlipayOpenAppCeitemItemCreateModel extends AlipayObject {
	...
	private static final long serialVersionUID = 8633659233377422832L;

	/**
	 * null
	 */
	@ApiListField("attrs")
	@ApiField("ce_item_attr_v_o")
	private List<CeItemAttrVO> attrs;
...
仅叶子类目支持创建商品。
	 ...
	 */
	@ApiField("desc_info")
	private CeItemDescInfoVO descInfo;
	 ...
	 */
	@ApiListField("skus")
	@ApiField("ce_item_sku_create_v_o")
	private List<CeItemSkuCreateVO> skus;

	/**
	 * 库存，单位：件，若填写了skus[]数组，此字段不用填写。
若未填写skus[]数组，此字段选填。
目前支持库存区间为0-99999999。
	 */
	@ApiField("stock_num")
	...
	public List<CeItemAttrVO> getAttrs() {
		return this.attrs;
	}
	public void setAttrs(List<CeItemAttrVO> attrs) {
		this.attrs = attrs;
	}
	...
	public CeItemDescInfoVO getDescInfo() {
		return this.descInfo;
	}
	public void setDescInfo(CeItemDescInfoVO descInfo) {
	...
	public List<CeItemSkuCreateVO> getSkus() {
		return this.skus;
	}
	public void setSkus(List<CeItemSkuCreateVO> skus) {
		this.skus = skus;
	}
