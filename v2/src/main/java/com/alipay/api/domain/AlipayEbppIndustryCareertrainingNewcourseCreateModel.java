 ...
 */
public class AlipayEbppIndustryCareertrainingNewcourseCreateModel extends AlipayObject {

	private static final long serialVersionUID = 2535112415389195622L;
	...
	@ApiField("class_info_v_o")
	private List<ClassInfoVO> planRuleList;
	...
	@ApiField("syllabus_structured_create_v_o")
	private List<SyllabusStructuredCreateVO> syllabusStructured;
	...
	public List<ClassInfoVO> getPlanRuleList() {
		return this.planRuleList;
	}
	public void setPlanRuleList(List<ClassInfoVO> planRuleList) {
	...
	public List<SyllabusStructuredCreateVO> getSyllabusStructured() {
		return this.syllabusStructured;
	}
	public void setSyllabusStructured(List<SyllabusStructuredCreateVO> syllabusStructured) {
