 ...
 *
 * @author auto create
 * @since 1.0, 2023-03-31 14:04:13
 */
public class AntOcrTesConsultModel extends AlipayObject {

	private static final long serialVersionUID = 8874575181799938321L;
	...
	public String getTrhee() {
		return this.trhee;
	}
	public void setTrhee(String trhee) {
		this.trhee = trhee;
	}
