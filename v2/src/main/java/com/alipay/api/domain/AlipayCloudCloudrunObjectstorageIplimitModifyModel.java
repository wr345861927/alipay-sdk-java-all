 ...
 *
 * @author auto create
 * @since 1.0, 2023-09-20 16:54:11
 */
public class AlipayCloudCloudrunObjectstorageIplimitModifyModel extends AlipayObject {

	private static final long serialVersionUID = 6777359772142957531L;
	...
	/**
	 * IP列表。
输入IP段（不可重复，例如：192.168.0.0/24）或IP地址（例如192.168.0.1）。支持IPv6地址、IPv4地址。
IPv6地址不支持::缩写格式，例如：不支持FC00:0AA3::0023:0003:0300:300A:1234。支持输入IP段，例如：FC00:0AA3:0000:0000:0000:0000:0000:0000/48。
	 */
