 ...
 *
 * @author auto create
 * @since 1.0, 2025-08-11 10:21:24
 */
public class DatadigitalAnttechWeatherFutureSubmitModel extends AlipayObject {

	private static final long serialVersionUID = 8252247969254455423L;
	...
	/**
	 * 此前预测的天数, 为 0 到 5 之间的整数，此前几天的预测结果
	 */
	@ApiField("past_days")
