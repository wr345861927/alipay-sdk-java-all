...
/**
 * fetchPaymentCredentials接口风控信息。 Fraud data provided by Apple as outlined in separate Fraud SIA document, if applicable.
...
public class CredentialsFraudData extends AlipayObject {
	...
	private static final long serialVersionUID = 3478752198497969454L;
	...
	/**
	 * 生物核身是否可获取。
true if device is capable of biometric
