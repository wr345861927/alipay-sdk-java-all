 ...
 *
 * @author auto create
 * @since 1.0, 2021-03-25 14:31:09
 */
public class DiscountInfoConfig extends AlipayObject {

	private static final long serialVersionUID = 6241851476963133995L;
...
比如：99代表0.99元
	...
	/**
	 * 优惠立减值, 分为单位
如果discount_type=reduce，那么就是具体的优惠立减额，比如：999代表满足一定金额减9.99元；

如果discount_type=random，那么就是”最小额-最大额“，比如:99-990，代表立减范围从0.99元到9.99元随机决策
	 */
