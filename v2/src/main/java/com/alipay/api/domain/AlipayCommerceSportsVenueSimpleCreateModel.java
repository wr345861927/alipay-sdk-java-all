 ...
 */
public class AlipayCommerceSportsVenueSimpleCreateModel extends AlipayObject {

	private static final long serialVersionUID = 2415891859114645864L;
	...
	/**
	 * 场馆设施（传数字）：1地板、2灯光、3淋浴、4餐饮、5WiFi、6更衣室、7充电宝、8停车场、9休息区
	 */
	...
	/**
	 * 接入方式： 空值/不传值/center = 中心化 (场馆走文体中心统一展示样式）；
...
smid：通过smid收款
	...
	/**
	 * （半中心化场馆）不填;
 （中心化场馆）收款类型 （indirect=间连/direct=直连） 直连：收款方为商户/场馆 间连：收款方为服务商
	 */
