...
import com.alipay.api.domain.AnttechOceanbasePassinfoLogininfoQueryModel;
...
public class AnttechOceanbasePassinfoLogininfoQueryRequest implements AlipayRequest<AnttechOceanbasePassinfoLogininfoQueryResponse> {
	...
	* 获取登录用户信息
	...
	public Class<AnttechOceanbasePassinfoLogininfoQueryResponse> getResponseClass() {
		return AnttechOceanbasePassinfoLogininfoQueryResponse.class;
	}
