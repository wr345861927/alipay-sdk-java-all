...
public class ZhimaCreditPayafteruseCreditagreementSignRequest implements AlipayRequest<ZhimaCreditPayafteruseCreditagreementSignResponse> {
	...
	* 先用后付记签约
	...
	public Class<ZhimaCreditPayafteruseCreditagreementSignResponse> getResponseClass() {
		return ZhimaCreditPayafteruseCreditagreementSignResponse.class;
	}
