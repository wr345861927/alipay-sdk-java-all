...
public class AlipayCommerceEcEnterpriseReliableCreateRequest implements AlipayRequest<AlipayCommerceEcEnterpriseReliableCreateResponse> {
	...
	* 可信渠道创建企业
	...
	public String getApiMethodName() {
		return "alipay.commerce.ec.enterprise.reliable.create";
	}
	...
	public Class<AlipayCommerceEcEnterpriseReliableCreateResponse> getResponseClass() {
		return AlipayCommerceEcEnterpriseReliableCreateResponse.class;
	}
