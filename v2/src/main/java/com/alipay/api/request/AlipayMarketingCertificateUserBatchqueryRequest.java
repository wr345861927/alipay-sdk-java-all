...
import com.alipay.api.domain.AlipayMarketingCertificateUserBatchqueryModel;
...
public class AlipayMarketingCertificateUserBatchqueryRequest implements AlipayRequest<AlipayMarketingCertificateUserBatchqueryResponse> {
	...
	* 条件查询用户凭证
	...
	public Class<AlipayMarketingCertificateUserBatchqueryResponse> getResponseClass() {
		return AlipayMarketingCertificateUserBatchqueryResponse.class;
	}
