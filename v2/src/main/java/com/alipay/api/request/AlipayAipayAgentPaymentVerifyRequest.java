...
public class AlipayAipayAgentPaymentVerifyRequest implements AlipayRequest<AlipayAipayAgentPaymentVerifyResponse> {
	...
	* A2A场景下商户拿到支付凭证向支付宝请求验证
	...
	public String getApiMethodName() {
		return "alipay.aipay.agent.payment.verify";
	}
	...
	public Class<AlipayAipayAgentPaymentVerifyResponse> getResponseClass() {
		return AlipayAipayAgentPaymentVerifyResponse.class;
	}
