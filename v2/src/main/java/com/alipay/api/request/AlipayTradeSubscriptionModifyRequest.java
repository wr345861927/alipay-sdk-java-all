...
public class AlipayTradeSubscriptionModifyRequest implements AlipayRequest<AlipayTradeSubscriptionModifyResponse> {
	...
	* 提供商户修改订阅信息的能力
	...
	public String getApiMethodName() {
		return "alipay.trade.subscription.modify";
	}
	...
	public Class<AlipayTradeSubscriptionModifyResponse> getResponseClass() {
		return AlipayTradeSubscriptionModifyResponse.class;
	}
