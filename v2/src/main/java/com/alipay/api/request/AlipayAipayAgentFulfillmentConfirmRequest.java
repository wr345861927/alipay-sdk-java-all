...
public class AlipayAipayAgentFulfillmentConfirmRequest implements AlipayRequest<AlipayAipayAgentFulfillmentConfirmResponse> {
	...
	* A2A商家履约回执确认
	...
	public String getApiMethodName() {
		return "alipay.aipay.agent.fulfillment.confirm";
	}
	...
	public Class<AlipayAipayAgentFulfillmentConfirmResponse> getResponseClass() {
		return AlipayAipayAgentFulfillmentConfirmResponse.class;
	}
