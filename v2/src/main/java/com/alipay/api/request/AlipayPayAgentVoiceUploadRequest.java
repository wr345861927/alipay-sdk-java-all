...
import com.alipay.api.response.AlipayPayAgentVoiceUploadResponse;
...
public class AlipayPayAgentVoiceUploadRequest implements AlipayRequest<AlipayPayAgentVoiceUploadResponse> {
	...
	* 智能体商户将用户语音上传，用于后续智能体代理支付流程中的语音核验，进行声纹核身支付
	...
	public String getApiMethodName() {
		return "alipay.pay.agent.voice.upload";
	}
	...
	public Class<AlipayPayAgentVoiceUploadResponse> getResponseClass() {
		return AlipayPayAgentVoiceUploadResponse.class;
	}
