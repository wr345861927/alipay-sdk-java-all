...
import com.alipay.api.response.AlipaySocialBaseChatGmemberConfirmResponse;
...
public class AlipaySocialBaseChatGmemberConfirmRequest implements AlipayRequest<AlipaySocialBaseChatGmemberConfirmResponse> {
	...
	* 判断支付宝群成员是否在群中
	...
	public Class<AlipaySocialBaseChatGmemberConfirmResponse> getResponseClass() {
		return AlipaySocialBaseChatGmemberConfirmResponse.class;
	}
