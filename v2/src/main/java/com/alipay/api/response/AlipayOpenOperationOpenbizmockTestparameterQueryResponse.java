...
public class AlipayOpenOperationOpenbizmockTestparameterQueryResponse extends AlipayResponse {
	...
	private static final long serialVersionUID = 3367892645321735317L;
	...
	public void setResultAppidoutone(String resultAppidoutone) {
		this.resultAppidoutone = resultAppidoutone;
	}
	public String getResultAppidoutone( ) {
		return this.resultAppidoutone;
	}

	public void setResultAppidouttwo(String resultAppidouttwo) {
		this.resultAppidouttwo = resultAppidouttwo;
	}
	...
	public void setResultOneuidOriiginal(String resultOneuidOriiginal) {
		this.resultOneuidOriiginal = resultOneuidOriiginal;
	}
	public String getResultOneuidOriiginal( ) {
		return this.resultOneuidOriiginal;
	}

	public void setResultOneuidOriiginalOpenid(String resultOneuidOriiginalOpenid) {
		this.resultOneuidOriiginalOpenid = resultOneuidOriiginalOpenid;
	}
	...
	public void setResultTestOriginalOpenid(String resultTestOriginalOpenid) {
		this.resultTestOriginalOpenid = resultTestOriginalOpenid;
	}
	public String getResultTestOriginalOpenid( ) {
		return this.resultTestOriginalOpenid;
	}

	public void setResultTestOriginalStates(String resultTestOriginalStates) {
		this.resultTestOriginalStates = resultTestOriginalStates;
	}
	public String getResultTestOriginalStates( ) {
		return this.resultTestOriginalStates;
	}

	public void setResultTestOriginalStatesOpenid(String resultTestOriginalStatesOpenid) {
		this.resultTestOriginalStatesOpenid = resultTestOriginalStatesOpenid;
	}
	public String getResultTestOriginalStatesOpenid( ) {
		return this.resultTestOriginalStatesOpenid;
	}

	public void setResultTestOriginalStatesTest(OpenidComplex resultTestOriginalStatesTest) {
		this.resultTestOriginalStatesTest = resultTestOriginalStatesTest;
	}
	...
	public void setResultTwouidOriiginal(String resultTwouidOriiginal) {
		this.resultTwouidOriiginal = resultTwouidOriiginal;
	}
	public String getResultTwouidOriiginal( ) {
		return this.resultTwouidOriiginal;
	}

	public void setResultTwouidOriiginalOpenid(String resultTwouidOriiginalOpenid) {
		this.resultTwouidOriiginalOpenid = resultTwouidOriiginalOpenid;
	}
