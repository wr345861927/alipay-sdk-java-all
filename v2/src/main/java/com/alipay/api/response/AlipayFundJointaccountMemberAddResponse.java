...
/**
 * ALIPAY API: alipay.fund.jointaccount.member.add response.
 * 
 * @author auto create
 * @since 1.0, 2025-04-21 14:52:28
 */
public class AlipayFundJointaccountMemberAddResponse extends AlipayResponse {

	private static final long serialVersionUID = 2765121953711682144L;
