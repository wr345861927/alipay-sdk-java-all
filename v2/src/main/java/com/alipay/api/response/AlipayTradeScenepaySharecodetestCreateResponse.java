...
/**
 * ALIPAY API: alipay.trade.scenepay.sharecodetest.create response.
 * 
 * @author auto create
 * @since 1.0, 2023-10-13 15:51:47
 */
public class AlipayTradeScenepaySharecodetestCreateResponse extends AlipayResponse {

	private static final long serialVersionUID = 1738943278769675811L;
	...
	/** 
	 * 吱口令引导文案前半段，即示例值中吱口令码值的前一句文案【#吱口令# 长按复制此条消息即可分享，】
	 */
