...
import com.alipay.api.domain.IndustryBkAgentRespInfo;
import com.alipay.api.domain.IndustryChargeInfo;
import com.alipay.api.domain.EnterprisePayInfo;
import com.alipay.api.domain.IndustryFulfillmentDetail;
import com.alipay.api.domain.IndustryTradeFundBill;
import com.alipay.api.domain.IndustryHbFqPayInfo;
import com.alipay.api.domain.IndustryIntactChargeInfo;
import com.alipay.api.domain.IndustryPaymentInfoWithId;
import com.alipay.api.domain.GoodsDetail;
import com.alipay.api.domain.IndustryTradeSettleInfo;
...
public class AlipayCommerceWithholdrepayorderTradeQueryResponse extends AlipayResponse {
	...
	private static final long serialVersionUID = 2188334481727116262L;
	...
	private IndustryBkAgentRespInfo bkagentRespInfo;
	...
	@ApiField("industry_charge_info")
	private List<IndustryChargeInfo> chargeInfoList;
	...
	@ApiField("industry_intact_charge_info")
	private List<IndustryIntactChargeInfo> intactChargeInfoList;
	...
	@ApiField("industry_payment_info_with_id")
	private List<IndustryPaymentInfoWithId> paymentInfoWithIdList;
	...
	private IndustryTradeSettleInfo tradeSettleInfo;
	...
	public void setBkagentRespInfo(IndustryBkAgentRespInfo bkagentRespInfo) {
		this.bkagentRespInfo = bkagentRespInfo;
	}
	public IndustryBkAgentRespInfo getBkagentRespInfo( ) {
	...
	public void setChargeInfoList(List<IndustryChargeInfo> chargeInfoList) {
		this.chargeInfoList = chargeInfoList;
	}
	public List<IndustryChargeInfo> getChargeInfoList( ) {
	...
	public void setFulfillmentDetailList(IndustryFulfillmentDetail fulfillmentDetailList) {
		this.fulfillmentDetailList = fulfillmentDetailList;
	}
	public IndustryFulfillmentDetail getFulfillmentDetailList( ) {
		return this.fulfillmentDetailList;
	}

	public void setFundBillList(IndustryTradeFundBill fundBillList) {
		this.fundBillList = fundBillList;
	}
	public IndustryTradeFundBill getFundBillList( ) {
		return this.fundBillList;
	}

	public void setHbFqPayInfo(IndustryHbFqPayInfo hbFqPayInfo) {
		this.hbFqPayInfo = hbFqPayInfo;
	}
	public IndustryHbFqPayInfo getHbFqPayInfo( ) {
	...
	public void setIntactChargeInfoList(List<IndustryIntactChargeInfo> intactChargeInfoList) {
		this.intactChargeInfoList = intactChargeInfoList;
	}
	public List<IndustryIntactChargeInfo> getIntactChargeInfoList( ) {
	...
	public void setPaymentInfoWithIdList(List<IndustryPaymentInfoWithId> paymentInfoWithIdList) {
		this.paymentInfoWithIdList = paymentInfoWithIdList;
	}
	public List<IndustryPaymentInfoWithId> getPaymentInfoWithIdList( ) {
	...
	public void setTradeSettleInfo(IndustryTradeSettleInfo tradeSettleInfo) {
		this.tradeSettleInfo = tradeSettleInfo;
	}
	public IndustryTradeSettleInfo getTradeSettleInfo( ) {
