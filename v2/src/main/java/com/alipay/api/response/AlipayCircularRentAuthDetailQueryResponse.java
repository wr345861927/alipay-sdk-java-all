...
import com.alipay.api.domain.CreditRiskDTO;

import com.alipay.api.AlipayResponse;

/**
 * ALIPAY API: alipay.circular.rent.auth.detail.query response.
 * 
 * @author auto create
 * @since 1.0, 2025-10-14 16:27:40
 */
public class AlipayCircularRentAuthDetailQueryResponse extends AlipayResponse {

	private static final long serialVersionUID = 6296988336727372739L;
	...
	private CreditRiskDTO creditRiskInfo;
	...
	public void setCreditRiskInfo(CreditRiskDTO creditRiskInfo) {
		this.creditRiskInfo = creditRiskInfo;
	}
	public CreditRiskDTO getCreditRiskInfo( ) {
